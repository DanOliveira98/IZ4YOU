	  ...
	  <div class="grid">
	    ...
	    <form action="" method="POST" class="form login">
	      ...
	      <div class="form__field">
	        ...
	        <input id="login__username" type="text" name="username" class="form__input" placeholder="Username" required maxlength="5">
	      </div>
	      ...
	      <div class="form__field">
	        ...
	        <input id="login__password" type="password" name="password" class="form__input" placeholder="Password" required minlength="6" maxlength="12">
	      </div>
